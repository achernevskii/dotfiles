...
apt install -qq --assume-yes ubuntu-restricted-extras

#install microsoft fonts
echo -en "\033[37;1;41m Microsoft Fonts \033[0m Installation \n"
apt -qq --assume-yes install msttcorefonts
fc-cache -fv
...
apt -qq --assume-yes update
apt -qq --assume-yes install telegram
...
apt update
apt -qq --assume-yes install spotify-client
...
apt -qq --assume-yes install browser-plugin-freshplayer-pepperflash
#install chrome
echo -en "\033[37;1;41m Chromium \033[0m Installation \n"
apt -qq --assume-yes install chromium-browser

#install unetbootin
echo -en "\033[37;1;41m Unetbootin \033[0m Installation \n"
add-apt-repository -y ppa:gezakovacs/ppa
apt update
apt -qq --assume-yes install unetbootin
...
apt -qq --assume-yes install cryptsetup
...
apt -qq --assume-yes install mysql-server

#MySql-workbench installation
echo -en "\033[37;1;41m MySql-Workbench \033[0m Installation \n"
apt -qq --assume-yes install mysql-workbench
